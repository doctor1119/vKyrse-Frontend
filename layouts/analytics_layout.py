    ...
    layout = html.Div([
        ...
        html.Div([
            ...
            html.Div([
                ...
                html.Div([
                    html.A(html.Button([
                        html.Span('Загрузить данные', className='load-data-button'),
                    ], id='load-data-button', className='btn btn-primary ml-3',
                        style={'height': 'auto', 'width': 'auto', 'display': 'flex', 'align-items': 'center',
                               'background-color': '#30D9CA',
                               'border-color': '#30D9CA',
                               'margin-left': '1vw',
